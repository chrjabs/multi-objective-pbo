...
# dependencies
build: build_deps build_maxpre s
...
CFLAGS += -DPREPRO -I maxpre/src
LFLAGS += -lmaxpre -L maxpre/src/lib

touch_cplex:
	touch cplex.make
clean: touch_cplex
clean_total: clean_deps clean clean_maxpre
# solver
